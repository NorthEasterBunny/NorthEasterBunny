...
3. On the Survey webpage, submit a survey config (you can copy-paste the example file from the [Example Survey](https://github.com/NorthEasterBunny/NorthEasterBunny/blob/main/ExampleSurvey.md)
